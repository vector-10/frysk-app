    ...
    <div className='fixed w-full px-[2rem] h-[4rem] flex items-center justify-between shadow-md border-white'>
        ...
        <h1 className='hover:scale-75 hover:rotate-12 transition duration-500 ease-in-out text-4xl'>Frysk</h1> 
         ...
         <div className='flex bg-white text-[#1c2337] py-1 px-2 rounded-2xl space-x-2'>
                <Link className="wiggly transition duration-500 ease-in-out hover:bg-[#1c2337] hover:text-white rounded-xl py-0.5 px-2.5" href="/dashboard">Home</Link>
                <Link className="wiggly transition duration-500 ease-in-out hover:bg-[#1c2337] hover:text-white rounded-xl py-0.5 px-2.5" href="/quiz">Vault</Link>
                <Link className="wiggly transition duration-500 ease-in-out hover:bg-[#1c2337] hover:text-white rounded-xl py-0.5 px-2.5" href="/pdf">Bridge</Link>
            </div>
